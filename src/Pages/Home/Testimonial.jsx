                        ...
                        <div key={singleFeedback?._id} className='text-center w-full'>
                            {
                                ...
                                <div className='w-full flex flex-col justify-center items-center gap-4'>
                                    ...
                                    <p className='absolute bottom-[40px] text-white font-semibold text-xl right-[80px]'>- {singleFeedback?.feedbackProvider}</p>
                                        <FaQuoteLeft className='text-3xl lg:text-5xl absolute top-[-10px] md:top-[-20px] left-[-5px] md:left-[-20px] text-[#c2c2c27e]'
                                        data-aos="slide-down"
                                        data-aos-mirror="true"
                                        data-aos-once="false"
                    ...
                    allFeedbacks.map(singleFeedback =>
                        <div key={singleFeedback?._id}>
                            <button onClick={() => setActiveFeedback(singleFeedback?._id)}>
                                <img src={singleFeedback?.feedbackProviderPhoto} alt="" className={`w-[65px] h-[65px] md:w-[80px] p-[2px] md:h-[80px] bg-cover border duration-500 rounded-full ${activeFeedback === singleFeedback?._id ? "border-sub" : "border-[#ffffff00]"}`} />
                            </button>
                        </div>
                    )
                }
